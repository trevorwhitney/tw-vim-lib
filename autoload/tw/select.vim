" Copied from coc explorer:
" https://github.com/weirongxu/coc-explorer/blob/master/autoload/coc_explorer/select_wins.vim
"
" returns
"   -1  - User cancelled
"   0   - No window selected
"   > 0 - Selected winnr
function! tw#select#start(buftypes, filetypes, floating_windows) abort
  let store = {}
