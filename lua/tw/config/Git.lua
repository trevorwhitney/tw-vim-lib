  ...
  require("gitsigns").setup({
    ...
    on_attach = function(bufnr)
      ...
      local keymap = {
        ...
        { "<leader>gd", "<cmd>lua require('tw.config.Git').diffSplit(vim.fn.input('[Commit] > '))<cr>", desc = "Diff Split (Against Commit)",  nowait = false, remap = false },
        ...
        { "<leader>go", "<cmd>lua require('tw.config.Git').browseCurrentLine()<cr>",                    desc = "Open Current Line in Browser", nowait = false, remap = false },
